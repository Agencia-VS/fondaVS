...
La partida usa una matriz 6×5 de 30 cartas (15 parejas), con un máximo de 7 minutos. La baraja se mezcla al iniciar y permanece oculta en el host. El cursor empieza en la primera carta disponible. No se puede repetir carta ni seleccionar una pareja encontrada. Los bordes no envuelven.
